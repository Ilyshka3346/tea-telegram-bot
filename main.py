...
CATALOG = {
    ...
    '7': {
        ...
        'description': 'Шу Пуэр 2017г. завода «Юньфусян» 357гр. Вкус: древесина, земля с нотками бани, грецкого ореха, сухофруктов и лёгкой сливочностью ❗ЦЕЛОГО БЛИНА НЕТ В НАЛИЧИИ❗',
        'price': 3140,
        'weight': '357гр',
        'price_per_gram': 8,
    ...
    '12': {
        ...
        'description': 'Шу Пуэр 2005г. завода «Чжоуши» 357гр. ❗ЦЕЛОГО БЛИНА НЕТ В НАЛИЧИИ❗',
        'price': 2220,
        'weight': '357гр',
        'price_per_gram': 5.3,
